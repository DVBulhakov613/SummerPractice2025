...
namespace OOP_CourseProject_TestProject
{
    ...
    public static class TestUtilities
    {
        ...
        public static IEnumerable<object[]> CorrectCoordinates => new List<object[]>
            {
                // all are valid
                new object[] { new Coordinates(50.4501, 30.5234, "Khreshchatyk St, Kyiv, 01001", "Kyiv", "Ukraine") },
                new object[] { new Coordinates(49.8397, 24.0297, "Svobody Ave, Lviv, 79000", "Lviv", "Ukraine") },
                new object[] { new Coordinates(48.4647, 35.0462, "Dnipro City Center, Dnipro, 49000", "Dnipropetrovsk", "Ukraine") },
                new object[] { new Coordinates(46.4825, 30.7233, "Deribasivska St, Odesa, 65000", "Odesa", "Ukraine") },
                new object[] { new Coordinates(47.8388, 35.1396, "Soborna St, Zaporizhzhia, 69000", "Zaporizhzhia", "Ukraine") },
                new object[] { new Coordinates(50.9077, 34.7981, "Peremohy Square, Sumy, 40000", "Sumy", "Ukraine") },
                new object[] { new Coordinates(49.9935, 36.2304, "Sumska St, Kharkiv, 61000", "Kharkiv", "Ukraine") },
                new object[] { new Coordinates(48.6208, 22.2879, "Narodna Sq, Uzhhorod, 88000", "Zakarpattia", "Ukraine") },
                new object[] { new Coordinates(49.5535, 25.5948, "Shevchenka Blvd, Ternopil, 46000", "Ternopil", "Ukraine") },
                new object[] { new Coordinates(48.9215, 24.7097, "Nezalezhnosti St, Ivano-Frankivsk, 76000", "Ivano - Frankivsk", "Ukraine") }
            };

        public static IEnumerable<object[]> IncorrectCoordinates => new List<object[]>
            {
                // latitude out of range (> 90)
                new object[] { new Coordinates(95.0000, 30.5234, "Khreshchatyk St, Kyiv, 01001", "Kyiv", "Ukraine") },

                // longitude out of range (< -180)
                new object[] { new Coordinates(50.4501, -190.0000, "Khreshchatyk St, Kyiv, 01001", "Kyiv", "Ukraine") },

                // mismatched city and coordinates (Kyiv address with Lviv coordinates)
                new object[] { new Coordinates(49.8397, 24.0297, "Khreshchatyk St, Kyiv, 01001", "Kyiv", "Ukraine") },

                // coordinates in the ocean, address says Odesa
                new object[] { new Coordinates(0.0000, -140.0000, "Deribasivska St, Odesa, 65000", "Odesa", "Ukraine") },

                // typo in city name (kharkov instead of kharkiv), and bad lat/lon
                new object[] { new Coordinates(120.0000, 200.0000, "Sumska St, Kharkov, 61000", "Kharkov", "Ukraine") },

                // valid coordinates but for a different country
                new object[] { new Coordinates(51.5074, -0.1278, "Sumska St, Kharkiv, 61000", "Kharkiv", "Ukraine") }, // Coordinates for London

                // swapped lat/lon values
                new object[] { new Coordinates(30.5234, 50.4501, "Khreshchatyk St, Kyiv, 01001", "Kyiv", "Ukraine") },

                // completely invalid lat/lon (non-existent values)
                new object[] { new Coordinates(-999.999, 999.999, "Shevchenka Blvd, Ternopil, 46000", "Ternopil", "Ukraine") },

                // empty address but valid coordinates
                new object[] { new Coordinates(49.9935, 36.2304, "", "Kharkiv", "Ukraine") },

                // mismatched region and city
                new object[] { new Coordinates(48.4647, 35.0462, "Dnipro City Center, Dnipro, 49000", "Lviv", "Ukraine") }
            };
