...
namespace Class_Lib.Migrations
{
    ...
    [Migration("20250509141807_Delivery_FinancialTracking")]
    partial class Delivery_FinancialTracking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Class_Lib.Backend.Package_related.Delivery", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Class_Lib.Backend.Package_related.Package", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Class_Lib.Backend.Package_related.Delivery", b =>
                {
                    b.HasOne("Class_Lib.Backend.Package_related.Package", "Package")
                        .WithOne("Delivery")
                        .HasForeignKey("Class_Lib.Backend.Package_related.Delivery", "PackageID")
            ...
            modelBuilder.Entity("Class_Lib.PackageEvent", b =>
                {
                    b.HasOne("Class_Lib.Backend.Package_related.Delivery", null)
                        .WithMany("Log")
            ...
            modelBuilder.Entity("Class_Lib.Warehouse", b =>
                {
                    b.Navigation("DeliveriesSentFromHere");

                    b.Navigation("DeliveriesSentHere");
